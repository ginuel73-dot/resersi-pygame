...
## Introdução
Este projeto pediu-nos para implementar o jogo Reversi utilizando a linguagem Python e a biblioteca PyGame, para avaliar os conhecimentos no desenvolvimento de códigos utilizando vareáveis, expressões instruções de entrada/saída de dados, tipos estruturas de dados, funções, instruções de decisão e de repetição .
...
- `main.py`: parte gráfica e interação com o utilizador
